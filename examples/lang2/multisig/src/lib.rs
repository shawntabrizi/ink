...
mod multisig {
    ...
    #[ink(storage)]
    struct MultiSig {
        transactions: u64 => bool;
        confirmations: storage::HashMap<(u64, AccountId), bool>,
        is_owner: storage::HashMap<AccountId, bool>,
    ...
    impl MultiSig {
        #[ink(constructor)]
        fn new(&mut self, owners: Vec<AccountId>, required: u64) {
